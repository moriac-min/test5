package kr.or.kpetro.com.sym.log.lgm.service;
...
public class EgovSysLogAspect {
	...
	public Object logInsert(ProceedingJoinPoint joinPoint) throws Throwable {
		...
		try {
	    	...
	    	/* Authenticated  */
	        RequestVO reqvo = EgovUserDetailsHelper.getRequestVO();
	        if(reqvo!=null)
	    	{
				//LoginVO user = (LoginVO)EgovUserDetailsHelper.getAuthenticatedUser();
				if(reqvo.getBody()!=null&&reqvo.getBody().getUserId()!=null)uniqId = reqvo.getBody().getUserId();
				ip = reqvo.getLocalAddr();
				serverNm = reqvo.getServerNm();
	    	}
